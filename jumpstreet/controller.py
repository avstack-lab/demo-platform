...
parser = argparse.ArgumentParser(description='Execute multiple Python files concurrently.')
parser.add_argument('command', choices=AVAILABLE_COMMANDS, help='the command to run')
